...
FLASHMEM void MD_MFTrack::reset(void)
{
...
FLASHMEM bool MD_MFTrack::getEndOfTrack(void)
// true if end of track has been reached
{
  return _endOfTrack;
}

FLASHMEM void MD_MFTrack::syncTime(void)
{
  _elapsedTicks = 0;
}

FLASHMEM void MD_MFTrack::restart(void)
...
FLASHMEM bool MD_MFTrack::getNextEvent(MD_MIDIFile *mf, uint16_t tickCount)
...
FLASHMEM void MD_MFTrack::parseEvent(MD_MIDIFile *mf)
...
FLASHMEM int MD_MFTrack::load(uint8_t trackId, MD_MIDIFile *mf)
